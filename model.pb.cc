...
void protobuf_AssignDesc_model_2eproto() {
  ...
  static const int Model_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Model, model_name_),
  };
  Model_reflection_ =
...
void protobuf_AddDesc_model_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013model.proto\022\014open_bracket\"\033\n\005Model\022\022\n\n"
    "model_name\030\001 \001(\t", 56);
...
#ifndef _MSC_VER
const int Model::kModelNameFieldNumber;
#endif  // !_MSC_VER

Model::Model()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:open_bracket.Model)
}
...
Model::Model(const Model& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:open_bracket.Model)
}
...
Model::~Model() {
  // @@protoc_insertion_point(destructor:open_bracket.Model)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:open_bracket.Model)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:open_bracket.Model)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:open_bracket.Model)
  return false;
#undef DO_
}
...
void Model::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:open_bracket.Model)
  // optional string model_name = 1;
  if (has_model_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->model_name().data(), this->model_name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:open_bracket.Model)
}

::google::protobuf::uint8* Model::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:open_bracket.Model)
  // optional string model_name = 1;
  if (has_model_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->model_name().data(), this->model_name().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:open_bracket.Model)
  return target;
}
